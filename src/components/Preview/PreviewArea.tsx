...
/* WebGPU ?„ë¦¬ë·??”ì§„ ?µí•© ??Phase 1 ?„ì „ êµì²´ */
/* ê¸°ì¡´ ê¸°ëŠ¥ 100% ë³´ì¡´ + WebGPU ê°€??+ ?¤ë²„?ˆì´ + ???´ë°” */
...
/* ?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•??   ?´ì§• ?¨ìˆ˜ (ê¸°ì¡´ ê·¸ë?ë¡?? ì?)
...
/* ?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•??   PreviewArea ì»´í¬?ŒíŠ¸ ???„ì „ ?µí•© ë²„ì „
   ?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•??*/
export function PreviewArea() {
      ...
      if (asset.hasAudio || asset.type === 'audio') {
        if (!audioEngine.getBuffer(asset.id)) {
          audioEngine.loadBuffer(asset.id, asset.src).catch(() => {
            console.warn(`[AudioEngine] ë²„í¼ ë¡œë“œ ?¤íŒ¨: ${asset.name}`);
          });
        }
      }
    }
  ...
  /* ?â•???¤í”„?ˆì„ ê¸°ë°˜ drawClip (ê¸°ì¡´ ê·¸ë?ë¡? ?â•??*/
  ...
  useEffect(() => {
    ...
    const updateSize = () => {
      ...
      // ëª¨ë“  ìº”ë²„???ˆì´???¬ê¸° ?™ê¸°??      [gpuCanvasRef.current, fallbackCanvasRef.current, overlayCanvasRef.current].forEach(c => {
        if (c) {
          c.style.width = `${w}px`;
          c.style.height = `${h}px`;
          // overlay?€ fallback?€ ?¼ë¦¬ ?¬ê¸°???¤ì •
  ...
  /* ?â•??ë©”ì¸ ?Œë” ë£¨í”„ ??WebGPU ?°ì„ , Canvas2D ?´ë°± ?â•??*/
  useEffect(() => {
    let rafId: number;
    ...
    const draw = () => {
      ...
      /* ?€?€ WebGPU ê²½ë¡œ: ?¤í”„?ˆì„/?´í™???„í™˜ ?†ëŠ” ?¨ìˆœ ë¹„ë””???¬ìƒ ?€?€ */
      ...
      if (useWebGPU && clip) {
        ...
        /* ?€?€ Canvas2D ?´ë°± ê²½ë¡œ (?¤í”„?ˆì„, ?´í™?? ?„í™˜, ?ìŠ¤???„ë? ì§€?? ?€?€ */
